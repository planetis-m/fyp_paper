...
#let title-text = "An Agent-Based Study Assistant System with OCR, Retrieval-Augmented Generation, and Text-to-Speech Tools"
...
#let institution = department + ", " + university
#let date = "May 2026"

#let paper = rgb("#f8f7f3")
#let ink = rgb("#17212b")
#let muted = rgb("#647181")
...
#let panel = rgb("#fffdfa")
#let shadow-line = rgb("#eef1f3")
#let bar-track = rgb("#e4e9ee")

#let slide-size = (width: 16cm, height: 9cm)
